...
export function Projects() {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: 22, maxWidth: 1200, marginLeft: 'auto', marginRight: 'auto' }}>
          ...
          <div style={{ transform: 'skewX(1.5deg)' }}>
            ...
            <div style={{ padding: '20px 22px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
                ...
                <span style={{ background: COLOR.accent, color: '#0b0a0a', fontFamily: "var(--font-bebas), sans-serif", letterSpacing: '.14em', padding: '2px 10px', fontSize: 15 }}>TEAM McCODERS</span>
              </div>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 7, marginBottom: 16 }}>
                <span style={{ border: `1px solid ${COLOR.accent}`, color: COLOR.accent, fontFamily: "var(--font-bebas), sans-serif", letterSpacing: '.1em', padding: '2px 9px', fontSize: 14 }}>NEXT.JS</span>
      ...
      <AngularCard style={{ transform: 'skewX(-1.5deg)' }}>
        <div style={{ background: '#141212', padding: 22, display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div style={{ transform: 'skewX(1.5deg)' }}>
            ...
            <div style={{ marginTop: 16, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              <span style={{ border: `1px solid ${COLOR.accent}`, color: COLOR.accent, fontFamily: "var(--font-bebas), sans-serif", letterSpacing: '.1em', padding: '2px 9px', fontSize: 14 }}>HACKATHON</span>
