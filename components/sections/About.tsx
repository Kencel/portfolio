...
export function About() {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(280px,1fr))', gap: 22, maxWidth: 1200 }}>
      <div style={{ background: '#141212', padding: '26px 28px', transform: 'skewX(-2deg)', ...angular(0) }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        <div style={{ background: 'var(--accent,#E4002B)', color: '#0b0a0a', padding: '18px 22px', transform: 'skewX(-4deg)', ...angular(1) }}>
        ...
        <div style={{ background: '#141212', padding: '18px 22px', transform: 'skewX(-4deg)', ...angular(2) }}>
